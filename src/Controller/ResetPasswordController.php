...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('', name: 'api_app_forgot_password_request')]
    public function request(Request $request,JWTTokenManagerInterface $jwtManager, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
     ...
     */
    #[Route('/check-email', name: 'api_app_check_email')]
